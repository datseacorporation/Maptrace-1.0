...
public class  MapsActivity extends FragmentActivity implements OnMapReadyCallback,LocationListener,GoogleMap.OnMapClickListener, GoogleMap.OnMarkerClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mUsers = FirebaseDatabase.getInstance().getReference("SuspectDetails");
        ...
        mUsers.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot s : dataSnapshot.getChildren()){
                    UserDataUpload user = s.getValue(UserDataUpload.class);
                    LatLng location = new LatLng(user.uLatitude,user.uLongitude);
